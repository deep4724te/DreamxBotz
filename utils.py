...
from info import  LONG_IMDB_DESCRIPTION, MAX_LIST_ELM, SHORTLINK_URL, SHORTLINK_API, IS_SHORTLINK, LOG_CHANNEL, TUTORIAL, GRP_LNK, CHNL_LNK, CUSTOM_FILE_CAPTION, DREAMCINEZONE_VERIFY_EXPIRE, AUTH_CHANNEL
...
async def verify_user(bot, userid, token):
    ...
    date_var = datetime.now(tz)+timedelta(hours=DREAMCINEZONE_VERIFY_EXPIRE)
